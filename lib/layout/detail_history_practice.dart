...
class DetailHistoryExample extends StatefulWidget {
  const DetailHistoryExample({super.key});

  @override
  State<DetailHistoryExample> createState() => _DetailHistoryExampleState();
}

class _DetailHistoryExampleState extends State<DetailHistoryExample> {
  List data = [
    {
      'id': 1,
      'question': 'Câu hỏi 1',
